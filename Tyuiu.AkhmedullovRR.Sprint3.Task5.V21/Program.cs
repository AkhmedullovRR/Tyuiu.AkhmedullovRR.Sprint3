...
using Tyuiu.AkhmedullovRR.Sprint3.Task5.V21.Lib;

namespace Tyuiu.AkhmedullovRR.Sprint3.Task5.V21
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #3 | Выполнил: Ахмедуллов Р. Р. | ИСТНб-23-1";
            Console.WriteLine("***************************************************************************");
